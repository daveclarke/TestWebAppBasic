...
.PARAMETER Clean
Removes the image testwebappbasic and kills all containers based on that image.
...
Build a Docker image named testwebappbasic
#>
...
$imageName="testwebappbasic"
$projectName="testwebappbasic"
$serviceName="testwebappbasic"
